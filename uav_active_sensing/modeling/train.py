...
def train_rl_agent():
    ...
    model = ActViTMAEForPreTraining.from_pretrained("facebook/vit-mae-base")  # TODO: load pretrained models locally
...
def train_mae():
    ...
    for img_batch in tiny_imagenet_train_loader:
        ...
        for img, sampled_img in img_pairs_generator(vect_env):
