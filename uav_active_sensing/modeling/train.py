...
from uav_active_sensing.config import PROCESSED_DATA_DIR, IMG_BATCH_SIZE
...
def main():
    ...
    tiny_imagenet_train_loader = DataLoader(
        tiny_imagenet_train_dataset, batch_size=IMG_BATCH_SIZE, collate_fn=tiny_imagenet_collate_fn
    )
